...
class UpahPolicy
{
    ...
    {
        return $user->can('delete_any_upah');
    }
     ...
     */
    public function replicate(User $user, Upah $upah): bool
    {
